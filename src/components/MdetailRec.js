...
const MdetailRec = () => {
  ...
  return (
    <>
      <ScrollChnage className="max-[480px]:top-[530px] max-[480px]:w-[100%]  max-[480px]:pl-0 max-[480px]:left-0 absolute top-[540px] h-[300px]  w-[98%] left-[20px]  rounded-[10px] pl-[25px]    bg-gray-900/20">
        <Slider1 {...settings}>
          {rec &&
            rec.map((item) => (
